            ...
            <tbody>
                <?php
                    $sqlAlumnos = "SELECT a.id_alumno,
                                    ...
                                    JOIN
                                        especialidad e ON g.id_especialidad = e.id_especialidad
                                    WHERE (g.id_semestre = '4' OR g.id_semestre = '5') AND a.status = 'INSCRITO' 
...
?>
        ...
        <button type="submit" class="enlace-verde-grande2" onclick="return confirm('¿Estás seguro de que deseas asignar estos alumnos a este grupo?');">Actualizar Grupo</button>
        </form>
    </div>
