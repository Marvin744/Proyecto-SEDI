...
include_once 'plantilla_asignaFunciones1.php';
// include_once 'tablaF191.php';
...
$plantilla = getPlantilla($folio, $fecha, $titulo, $docente, $horas, $array, $array2, $dia, $mesNombre, $ano, $periodo);
