                    ...
                    if (data.length > 0) {
                        ...
                        data.forEach(notification => {
                            let listItem = $(`
                                <li>
                                    <div style="display: flex; justify-content: space-between; align-items: center;">
                                        <div style="flex-grow: 1; cursor: pointer;" onclick="marcarNotificacionComoLeidaYRedirigir('${notification.mensaje}', '../Alertas/alerta.php')">
                            ...
                            listItem.find('a').on('click', function(e) {
                                e.preventDefault();
                                marcarNotificacionComoLeidaYRedirigir(notification.mensaje, '../Alertas/alerta.php');
                            });
        ...
        <div class="barra-lateral">
            ...
            <nav class="navegacion">
                <ul>
                    ...
                    switch ($perfil) {
                        case 'Admin':
                            echo '<li><a href="#"><ion-icon name="home-outline"></ion-icon><span>Dashboard Admin</span></a></li>';
                            echo '<li><a href="#"><ion-icon name="people-outline"></ion-icon><span>Gestionar Usuarios</span></a></li>';
                            echo '<li><a href="#"><ion-icon name="stats-chart-outline"></ion-icon><span>Reportes</span></a></li>';
                            break;
                        case 'Docente':
                            echo '<li><a href="#"><ion-icon name="home-outline"></ion-icon><span>Materias</span></a></li>';
