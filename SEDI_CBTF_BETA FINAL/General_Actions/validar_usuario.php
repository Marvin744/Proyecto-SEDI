<?php
    ...
    try {
        ...
        if ($resultado) {
            ...
            } elseif ($perfil === 'Psicologo_y_docente') {
                $consultaNombre = "SELECT nombre_docente, apellido_paterno, apellido_materno FROM docentes WHERE id_usuario = :idUsuario;";
            } elseif ($perfil === 'Administrativo') {
                $consultaNombre = "SELECT nombre_docente, apellido_paterno, apellido_materno FROM docentes WHERE id_usuario = :idUsuario;";
            } elseif ($perfil === 'Administrativo_y_docente') {
                $consultaNombre = "SELECT nombre_docente, apellido_paterno, apellido_materno FROM docentes WHERE id_usuario = :idUsuario;";
            } elseif ($perfil === 'Administrativo_Jefe') {
                $consultaNombre = "SELECT nombre_docente, apellido_paterno, apellido_materno FROM docentes WHERE id_usuario = :idUsuario;";
            } elseif ($perfil === 'Administrativo_Docente') {
                $consultaNombre = "SELECT nombre_docente, apellido_paterno, apellido_materno FROM docentes WHERE id_usuario = :idUsuario;";
            } elseif ($perfil === 'Directivo') {
                $consultaNombre = "SELECT nombre_docente, apellido_paterno, apellido_materno FROM docentes WHERE id_usuario = :idUsuario;";
            } elseif ($perfil === 'Directivo_y_docente') {
                $consultaNombre = "SELECT nombre_docente, apellido_paterno, apellido_materno FROM docentes WHERE id_usuario = :idUsuario;";
            } elseif ($perfil === 'Admin') {
                $consultaNombre = "SELECT nombre_docente, apellido_paterno, apellido_materno FROM docentes WHERE id_usuario = :idUsuario;";
            } else {
