                ...
                <form action="Actions/actualiza_perfil.php" method="post">
                    ...
                    <div>
                        ...
                        <select name="nuevo_perfil" id="nuevo_perfil" required>
                            ...
                            <option value="Administrativo_y_docente">Administrativo y Docente</option>
                            <option value="Psicologo_y_docente">Orientador y Docente</option>
                            <option value="Directivo">Directivo</option>
                            <option value="Directivo_y_docente">Directivo y Docente</option>
