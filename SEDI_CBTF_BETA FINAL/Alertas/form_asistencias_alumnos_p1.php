<?php
    ...
    verificarPermiso(['Admin', 'Docente', 'Psicologo_y_docente', 'Administrativo', 'Administrativo_y_docente', 'Administrativo_Docente', 'Administrativo_Jefe', 'Directivo_y_docente']);
?>
...
<body class="excel-upload">
    <section class="excel-upload-section">
        <h1>Asistencias Alumnos Parcial 1</h1>
    </section>
    ...
    <div>
        ...
        <form id="subir_csv" class="excel-upload-form" action="Actions/recibir_excelInasistencias_p1.php" method="POST" enctype="multipart/form-data">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const fileInput = document.getElementById('btn_subirAsistencias');
    const fileNameDisplay = document.getElementById('file-name');
    const uploadButton = document.querySelector('.excel-upload-button');
    ...
    document.getElementById("subir_csv").addEventListener("submit", function(event) {
        ...
        console.log("Formulario capturado y evento preventDefault aplicado.");

        var formData = new FormData(this);

        document.getElementById("loading").style.display = "block";

        fetch("Actions/recibir_excelInasistencias_p1.php", {
            method: "POST",
            body: formData
        })
        .then(response => {
            console.log("Respuesta recibida del servidor, procesando...");
        ...
        .then(data => {
            ...
            // Muestra la notificación con el mensaje correcto
