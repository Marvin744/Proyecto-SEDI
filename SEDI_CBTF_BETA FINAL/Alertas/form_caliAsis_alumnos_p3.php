...
<body class="excel-upload">
    <section class="excel-upload-section">
        <h1>Calificaciones Alumnos Parcial 2</h1>
    </section>
    ...
    <div>
        ...
        <form id="subir_csv" class="excel-upload-form" action="Actions/recibir_excelCalificaciones_p3.php" method="POST" enctype="multipart/form-data">
            <fieldset class="excel-upload-fieldset">
                <legend class="excel-upload-legend">Cargue el archivo de los alumnos</legend>
    ...
    <script>
        ...
        document.getElementById("subir_csv").addEventListener("submit", function(event) {
            ...
            fetch("Actions/recibir_excelCalificaciones_p3.php", {
                method: "POST",
                body: formData
            })
