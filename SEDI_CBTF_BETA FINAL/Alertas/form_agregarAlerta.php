<?php
    ...
    verificarPermiso(['Admin', 'Docente', 'Psicologo_y_docente', 'Administrativo', 'Administrativo_y_docente', 'Administrativo_Docente', 'Administrativo_Jefe', 'Directivo', 'Directivo_y_docente']);
?>
...
.custom-action-btn {
    ...
    font-family: 'Krub', sans-serif;
    color: white;
    background-color: #E00000; /* Azul como el encabezado */
    border: none;
