...
<body class="excel-upload">
    ...
    <div>
        ...
        <form id="subir_csv" class="excel-upload-form" action="Actions/recibir_excelCalificaciones_p2.php" method="POST" enctype="multipart/form-data">
    ...
    <script>
        ...
        document.getElementById("subir_csv").addEventListener("submit", function(event) {
            ...
            fetch("Actions/recibir_excelCalificaciones_p2.php", {
                method: "POST",
                body: formData
            })
