...
try {
    ...
    if (($handle = fopen($archivotmp, "r")) !== FALSE) {
        ...
        if (($handle = fopen($archivotmp, "r")) !== FALSE) {
            ...
            while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
                ...
                $inasistencias_p1 = !empty($data[39]) ? $data[39] : ''; // Columna 40 en Excel
                $asistencias_p1 = !empty($data[40]) ? $data[40] : '';   // Columna 41 en Excel
                $calificacion_p1 = !empty($data[47]) ? $data[47] : '';  // Columna 48 en Excel
                ...
                $sqlSelectAsistencias = "
                    SELECT asistencias_p1, inasistencias_p1 FROM asistencias
    ...
    //             var_dump($resultAsistencias);
                if (!$resultAsistencias) {
                    ...
                    INSERT INTO asistencias (asistencias_p1, inasistencias_p1, id_alumno, id_asignatura, id_grupo)
                    VALUES (:asistencias_p1, :inasistencias_p1, :id_alumno, :id_asignatura, :id_grupo);
                    ";
                    $stmtAsistencias = $conexion->prepare($sqlInsertAsistencias);
                    $stmtAsistencias->bindParam(':asistencias_p1', $asistencias_p1);
                    $stmtAsistencias->bindParam(':inasistencias_p1', $inasistencias_p1);
    ...
    // echo "Mensaje de error: " . $errorInfo[2] . "<br>";
                    ...
                    $current_asistencias_p1 = $resultAsistencias['asistencias_p1'];
                    $current_inasistencias_p1 = $resultAsistencias['inasistencias_p1'];
                    ...
                    if ($current_asistencias_p1 !== $asistencias_p1 || $current_inasistencias_p1 !== $inasistencias_p1) {
                        $sqlUpdateAsistencias = "
                            UPDATE asistencias 
                            SET asistencias_p1 = :asistencias_p1, inasistencias_p1 = :inasistencias_p1
                            WHERE id_alumno = :id_alumno AND id_asignatura = :id_asignatura;
                        ";
                        $stmtUpdateAsistencias = $conexion->prepare($sqlUpdateAsistencias);
                        $stmtUpdateAsistencias->bindParam(':asistencias_p1', $asistencias_p1);
                        $stmtUpdateAsistencias->bindParam(':inasistencias_p1', $inasistencias_p1);
                ...
                $sqlSelectCalificaciones = "
                    SELECT calificacion_p1 FROM calificaciones
                    WHERE id_alumno = :id_alumno AND id_asignatura = :id_asignatura LIMIT 1;
                ";
                  ...
                  throw new Exception("No se encontró la asistencia asociada para el alumno con ID $id_alumno y la asignatura $id_asignatura.");
                    ...
                    if ($resultCalificaciones === false) {
                        ...
                        $sqlInsertCalificaciones = "
                            INSERT INTO calificaciones (calificacion_p1, id_alumno, id_asignatura, id_asistencia, id_grupo)
                            VALUES (:calificacion_p1, :id_alumno, :id_asignatura, :id_asistencia, :id_grupo);
                        ";
                        ...
                        $stmtCalificaciones->bindParam(':calificacion_p1', $calificacion_p1);
                        ...
                        $current_calificacion_p1 = $resultCalificaciones['calificacion_p1'];
                        
                        if ($current_calificacion_p1 !== $calificacion_p1) {
                            ...
                            $stmtUpdateCalificaciones->bindParam(':calificacion_p1', $calificacion_p1);
