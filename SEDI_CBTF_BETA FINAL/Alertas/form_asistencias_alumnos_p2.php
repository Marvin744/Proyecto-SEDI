...
<body class="excel-upload">
    <section class="excel-upload-section">
        <h1>Asistencias Alumnos Parcial 2</h1>
    </section>
    ...
    <div>
        ...
        <form id="subir_csv" class="excel-upload-form" action="Actions/recibir_excelInasistencias_p2.php" method="POST" enctype="multipart/form-data">
    ...
    <script>
        ...
        document.getElementById("subir_csv").addEventListener("submit", function(event) {
            ...
            fetch("Actions/recibir_excelInasistencias_p2.php", {
                method: "POST",
                body: formData
            })
