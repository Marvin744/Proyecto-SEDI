            ...
            <select name="nuevo_grupo" id="nuevo_grupo">
                <?php 
                            $sqlGrupo = "SELECT g.id_grupo,
                                    ...
                                    WHERE        
                                            g.id_semestre = '1' OR g.id_semestre = '2';";
            ...
            <tbody>
                <?php
                    $sqlAlumnos = "SELECT a.id_alumno,
                                    ...
                                    JOIN
                                        especialidad e ON g.id_especialidad = e.id_especialidad
                                    WHERE (g.id_semestre = '1' OR g.id_semestre = '2') AND a.status = 'INSCRITO' 
...
?>
        ...
        <button class="enlace-verde-grande2" type="submit"
    ...
    $("#filtro").on("click", function(e) { 
        ...
        var grupos = $('#grupos').val();
            ...
            $.post("filtro2.php", {buscar: buscar, grupos: grupos}, function(data) {
