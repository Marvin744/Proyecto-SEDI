...
<body class="paginaexcel-page">
        ...
        <form id="filterForm" action="" method="GET">
            <fieldset>
                <div class="mb-3 text-center">
                    ...
                    <h2 style="font-weight: bold; margin-left: 8rem;">Consulta de Calificaciones</h2>
                    <p>Seleccione la asignatura y el grupo del que desea conocer las calificaciones y las asistencias de dicho grupo.</p><br>
                ...
                <div class="text-center mt-4">
                    <input class="btn-filtrar" type="submit" class="btn btn-primary" value="Filtrar"/>
                </div>
            </fieldset>
    ...
    <?php
        ...
        if (!empty($selectedGrupo) || !empty($selectedAsignatura)) {
            ...
            echo '<br><p class="text-center">Selecciona una asignatura y/o grupo para ver los resultados.</p>';
        }
        ?>
    </div>
</body>
