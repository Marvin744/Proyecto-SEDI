...
<head>
    ...
    function validarStatus() {
        ...
        if (status === 'BAJA PERMANENTE') {
            const confirmacion = confirm(
                "El status seleccionado es 'BAJA PERMANENTE'. ¿Está seguro de que desea proceder con la actualización?"
                );
            if (!confirmacion) {
        ...
        // Si el status no es 'BAJA PERMANENTE', el formulario se envía sin confirmación adicional
        return true;
    }
    </script>
...
<body>
    <form action="update_alumno.php" method="POST" id="form_updateAlumno" class="flex"
        ...
        <div class="form-page active">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="id_semestre" name="id_semestre"
                    value="<?php echo $mostrar['id_semestre']; ?>">
            </div>
            ...
            <div class="form-check">
                <input type="checkbox" class="form-check-input" id="ticket" name="ticket"
                    value="<?php echo $mostrar['ticket']; ?>"
                    <?php $retVal = ($mostrar['status'] = 'INSCRITO') ? 0 : 1 ; echo $retVal; ?>>
        ...
        <div class="form-page">
            <!-- Formulario NACIONALIDAD Y CONTACTO alumno -->
            ...
            <div class="form-check">
                <input type="checkbox" class="form-check-input" id="ayuda_espanol" name="ayuda_espanol"
                    value="<?php echo $mostrar['ayuda_espanol']; ?>"
                    <?php $retVal = ($mostrar['ayuda_espanol'] == 1) ? 'checked' : "" ; echo $retVal; ?>>
        ...
        <div class="form-page">
            <!-- Formulario EGRESO Y SALUD alumno -->
            ...
            <div class="form-check">
                ...
                <input type="checkbox" class="form-check-input" id="nss" name="nss"
                    onclick="toggleVisibility('nss_fields')" value="<?php echo $mostrar['nss']; ?>"
            ...
            <div class="form-check">
                ...
                <input type="checkbox" class="form-check-input" id="issste" name="issste"
                    onclick="toggleVisibility('issste_fields')" value="<?php echo $mostrar['issste']; ?>"
            ...
            <div class="form-check">
                <input type="checkbox" class="form-check-input" id="requiere_medicacion" name="requiere_medicacion"
                    ...
                    value="<?php echo $mostrar['requiere_medicacion']; ?>"
        ...
        <div class="form-page">
            <!-- Formulario CONTACTOS Y TUTORES alumno -->
        ...
        <div class="form-group">
            <input type="text" class="hidden" id="id_grupo" name="id_grupo" value="<?php echo $mostrar['id_grupo']; ?>">
        </div>

        <div class="form-buttons">
            <br>
            <button style="align-content: center; font-size: 1.8rem; padding: 5px;" type="button" id="btn-prev"
                disabled>Anterior</button>
            <button style="align-content: center; font-size: 1.8rem; padding: 5px;" type="button"
