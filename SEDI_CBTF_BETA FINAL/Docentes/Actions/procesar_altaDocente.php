...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $sql = "INSERT INTO docentes (id_usuario, titulo_estudios, nombre_docente, apellido_paterno, apellido_materno, RFC, genero, email, grupo_edad, tipo_plaza, 
                                      formacion_academica, antiguedad, nivel_estudios, beca, discapacidad, lengua_indigena, funcion, 
                                      estudio_actual, pais_estudio) 
                VALUES (:id_usuario,
                        UPPER(:titulo_docente),
