                ...
                <ul>
                    ...
                    switch ($perfil) {
                        ...
                        case 'Admin':
                            ...
                            echo '<li><a class="' . ($currentPage == 'proximamente.php' ? 'active' : '') . '" href="../vistas/proximamente.php"><ion-icon name="eye-outline"></ion-icon><span>Alertas Realizadas</span></a></li>';
                            ...
                            echo '<li><a class="' . ($currentPage == 'form_materias.php' ? 'active' : '') . '" href="../Asignar_Materia/form_materias.php"><ion-icon name="color-palette-outline"></ion-icon><span>Asignaturas</span></a></li>';
                        ...
                        // Perfil DOCENTE
                        case 'Docente':
                            echo '<a class="boton ' . (($currentPage == 'form_calAsis_alumnos.php' || $currentPage == 'form_asistencias_alumnos_p1.php' || $currentPage == 'form_asistencias_alumnos_p2.php' || $currentPage == 'form_asistencias_alumnos_p3.php' 
                        ...
                        case 'Psicologo_y_docente':
                            echo '<a class="boton ' . ($currentPage == 'form_alerta.php' ? 'active' : '') . '" href="../Alertas/form_alerta.php"><ion-icon name="document-text-outline"></ion-icon><span>Alertas</span></a>';
                            // echo '<li><a class="' . ($currentPage == 'form_inscripcion_alumno.php' ? 'active' : '') . '" href="../Inscripcion/form_inscripcion_alumno.php"><ion-icon name="person-outline"></ion-icon><span>Inscripción</span></a></li>';
                            // echo '<li><a class="' . (($currentPage == 'form_docente_f19.php' || $currentPage == 'form_tablaF19.php' || $currentPage == 'form_editar_docente.php') ? 'active' : '') . '" href="../Docentes/form_docente_f19.php"><ion-icon name="person-outline"></ion-icon><span>Personal y F19</span></a></li>';
                            // echo '<li><a class="' . ($currentPage == 'form_alta_docente.php' ? 'active' : '') . '" href="../Docentes/form_alta_docente.php"><ion-icon name="person-add-outline"></ion-icon><span>Registrar Personal</span></a></li>';
                            // echo '<li><a class="' . (($currentPage == 'form_perfilUsuario.php' || $currentPage == 'form_modificar_perfil.php') ? 'active' : '') . '" href="../Usuarios/form_perfilUsuario.php"><ion-icon name="people-outline"></ion-icon><span>Gestionar Usuarios</span></a></li>';
                        ...
                        // Perfil ALUMNO
                        case 'Alumno':
                            echo '<a class="boton ' . ($currentPage == 'form_calificacionAlumno.php' ? 'active' : '') . '" href="../Calificaciones/form_calificacionAlumno.php"><ion-icon name="eye-outline"></ion-icon><span>Calificaciones</span></a>';
                            echo '<li><a class="' . ($currentPage == 'proximamente.php' ? 'active' : '') . '" href="../vistas/proximamente.php"><ion-icon name="calendar-outline"></ion-icon><span>Horario</span></a></li>';
                            break;
                        ...
                        case 'Administrativo_Docente':
                            echo '<a class="boton ' . (($currentPage == 'form_docente_f19.php' || $currentPage == 'form_tablaF19.php' || $currentPage == 'form_editar_docente.php') ? 'active' : '') . '" href="../Docentes/form_docente_f19.php"><ion-icon name="person-outline"></ion-icon><span>Personal y F19</span></a>';
                            // echo '<li><a class="' . ($currentPage == 'form_inscripcion_alumno.php' ? 'active' : '') . '" href="../Inscripcion/form_inscripcion_alumno.php"><ion-icon name="person-outline"></ion-icon><span>Inscripción</span></a></li>';
                            // echo '<li><a class="' . (($currentPage == 'form_docente_f19.php' || $currentPage == 'form_tablaF19.php' || $currentPage == 'form_editar_docente.php') ? 'active' : '') . '" href="../Docentes/form_docente_f19.php"><ion-icon name="person-outline"></ion-icon><span>Personal y F19</span></a></li>';
                            echo '<li><a class="' . ($currentPage == 'form_alta_docente.php' ? 'active' : '') . '" href="../Docentes/form_alta_docente.php"><ion-icon name="person-add-outline"></ion-icon><span>Registrar Personal</span></a></li>';
                            echo '<li><a class="' . (($currentPage == 'form_perfilUsuario.php' || $currentPage == 'form_modificar_perfil.php') ? 'active' : '') . '" href="../Usuarios/form_perfilUsuario.php"><ion-icon name="people-outline"></ion-icon><span>Gestionar Usuarios</span></a></li>';
