                ...
                <tbody>
                    <?php
                        ...
                        $sqlAlertas = "SELECT alertas.id_alerta,
                                        ...
                                        INNER JOIN especialidad ON alertas.id_especialidad = especialidad.id_especialidad
                        ...
                        foreach ($queryTableAlertas as $row) {
                            ...
                            echo "<tr>
                                    ...
                                    <td class='alinear-izquierda'>{$row['semestre']}</td>
                                    <td class='alinear-centro'>{$row['nombre_grupo']}</td>
                                    <td class='alinear-izquierda'>{$row['nombre_especialidad']}</td>
                                    <td class='alinear-centro'>
                                        <button class='edit-btn' data-id='{$row['id_alerta']}' data-name='{$nombreCompleto}'>Editar</button>
                                        <button class='info-btn' data-id='{$row['id_alerta']}' data-name='{$nombreCompleto}'>Info</button>
                                    </td>
                                </tr>";
                        }
                    ?>
