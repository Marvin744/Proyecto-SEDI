<?php
    ...
    try {
        ...
        foreach ($lines as $line) {
            ...
            $inasistencias_p2 = !empty($datos[39]) ? $datos[39] : ''; // Columna para inasistencias_p2 (columna 40 en Excel)
            $asistencias_p2 = !empty($datos[40]) ? $datos[40] : '';  // Columna para asistencias_p2 (columna 41 en Excel)
            ...
            if (!$resultAsistencia) {
                ...
                $current_asistencias_p2 = $resultAsistencia['asistencias_p2'];
                $current_inasistencias_p2 = $resultAsistencia['inasistencias_p2'];
