<?php 
    ...
    //Checkpoint TODO FUNCIONAL DE AQUÍ
        ...
        foreach ($lines as $line) {
            ...
            if (!$resultAsistencias) {
                ...
                $sqlInsertAsistencias = "
                    INSERT INTO asistencias (asistencias_p1, inasistencias_p1, id_alumno)
                    VALUES (:asistencias_p1, :inasistencias_p1, :id_alumno);
                ";
                ...
                $current_asistencias_p1 = $resultAsistencias[0]['asistencias_p1'];
                $current_inasistencias_p1 = $resultAsistencias[0]['inasistencias_p1'];
            ...
            $sqlSelectCalificaciones = "
                ...
                WHERE id_alumno = :id_alumno AND id_asignatura = 350;
            ";
            ...
            if (!$resultCalificaciones) { // Cambiado de $resultCalificacion a $resultCalificaciones
                ...
                $sqlInsertCalificaciones = "
                    ...
                    VALUES (:calificacion_p1, :id_alumno, 350, :id_asistencia, :id_grupo);
                ";
                ...
                if ($current_calificacion_p1 !== $calificacion_p1) { // Cambiado de $calificacion_p2 a $calificacion_p1
