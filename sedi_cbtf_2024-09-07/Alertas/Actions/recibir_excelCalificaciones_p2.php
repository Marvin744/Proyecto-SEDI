<?php 
    ...
    try {
        ...
        foreach ($lines as $line) {
            ...
            $inasistencias_p1 = !empty($datos[39]) ? $datos[39] : ''; // Columna para inasistencias_p2 (columna 40 en Excel)
            $asistencias_p1 = !empty($datos[40]) ? $datos[40] : '';  // Columna para asistencias_p2 (columna 41 en Excel)
            $calificacion_p1 = !empty($datos[47]) ? $datos[47] : '';  // Columna para calificación_p2 (columna 48 en Excel)
            ...
            $id_asignatura = $resultAlumnos[0]['id_asignatura'];
            ...
            if (!$resultAsistencias) {
                ...
                $current_asistencias_p2 = $resultAsistencias[0]['asistencias_p2'];
                $current_inasistencias_p2 = $resultAsistencias[0]['inasistencias_p2'];
            ...
            $sqlSelectCalificaciones = "
                ...
                WHERE id_alumno = :id_alumno AND id_asignatura = :asignatura;
            ";
            ...
            if (!$resultCalificaciones) { // Cambiado de $resultCalificacion a $resultCalificaciones
                ...
                $current_calificacion_p1 = $resultCalificaciones[0]['calificacion_p2'];
