    ...
    $contenido .= '
            ...
            <tfoot>
                ...
                <tr class="oscuro">
                    ...
                    <td style="font-weight: bold; text-align: center; padding: 1px 1px;" id="total-lunes1">'.$subtotal_lunes1.'</td>
                    <td style="font-weight: bold; text-align: center; padding: 1px 1px;" id="total-martes1">'.$subtotal_martes1.'</td>
                    <td style="font-weight: bold; text-align: center; padding: 1px 1px;" id="total-miercoles1">'.$subtotal_miercoles1.'</td>
                    <td style="font-weight: bold; text-align: center; padding: 1px 1px;" id="total-jueves1">'.$subtotal_jueves1.'</td>
                    <td style="font-weight: bold; text-align: center; padding: 1px 1px;" id="total-viernes1">'.$subtotal_viernes1.'</td>
                    <td style="font-weight: bold; text-align: center; padding: 1px 1px;" id="total-sabado1">'.$subtotal_sabado1.'</td>
                    <td style="font-weight: bold; text-align: center; padding: 1px 1px;" id="total-horas"><strong>'.$subtotal_horas1.'</strong></td>
                </tr>
            </tfoot>
        </table>
        <br>
