...
<body>
    ...
    <table class="f19_table">
        ...
        <tfoot>
            ...
            <tr class="f19_header-row">
                ...
                <td class="f19_td" id="total1-horas-total"><strong><?php echo $totalHorasSemanales; ?></strong></td>
            </tr>
        </tfoot>
    </table>
    <br>
    ...
    <div class="datos_f19">
        <form action="plantilla_f19.php" method="post" target="_blank">
            ...
            <input type="hidden" id="hiddenTotalHoras" name="total1_horas">
    ...
    document.querySelector('form[action="plantilla_f19.php"]').addEventListener('submit', function() {
        ...
        document.getElementById('hiddenSubtotalHoras').value = document.getElementById('subtotal1-horas')
            .textContent;
        document.getElementById('hiddenTotalHoras').value = document.getElementById('total1-horas')
            .textContent;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateTotalHorasSemanal() {
            ...
            document.getElementById('total1-horas-total').textContent = totalHorasSemanales; // Mostrar el total como entero
        }
