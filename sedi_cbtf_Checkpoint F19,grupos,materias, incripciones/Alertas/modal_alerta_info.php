                ...
                <div class="modal-body">
                    <table class="table" border="1">
                        <thead>
                            ...
                            <tr>
                                <th>Semestre</th>
                                <td style="text-align: center"><?php echo $mostrar['nombre_semestre'] ?></td>
                            </tr>
                            <tr>
                                <th>Grupo</th>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tipo_alerta" id="tipo_alerta" class="form-control"
                                    value="<?php echo $mostrar['tipo_alerta']; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="condicionamiento" id="condicionamiento" class="form-control"
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="number" name="semestre" class="form-control"
                                    value="<?php echo $mostrar['nombre_semestre']; ?>">
                            </div> -->
                            <!-- <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="cita" id="cita" class="form-control"
                                    value="<?php echo $mostrar['cita']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Asistencia del Padre o Tutor:</label>
                                <input type="text" name="asistencia_padre_tutor" id="asistencia_padre_tutor" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="fecha_cumplimiento" id="fechacumplimiento" class="form-control"
