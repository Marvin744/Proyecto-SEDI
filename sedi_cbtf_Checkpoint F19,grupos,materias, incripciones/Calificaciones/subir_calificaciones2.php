...
<!-- Los botones para cargar los excel y para enviar los archivos -->
      ...
      <div class="row">
    <div class="col-md-7">
      <form onsubmit="advertencia(evento)" action="recibe_excel2.php" method="POST" enctype="multipart/form-data"/>
      ...
      <td>
          ...
          <input type="submit" onclick="advertencia(evento)" name="subir" class="btn btn-enviar" value="Subir Excel"/>
