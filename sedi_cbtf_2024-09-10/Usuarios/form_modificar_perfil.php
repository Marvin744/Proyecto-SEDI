                ...
                <form action="Actions/actualiza_perfil.php" method="post">
                    ...
                    <div>
                        ...
                        <select name="nuevo_perfil" id="nuevo_perfil" required>
                            ...
                            <option value="Administrativo-docente">Administrativo y Docente</option>
                            <option value="Psicologo-docente">Orientador y Docente</option>
                            <option value="Directivo">Directivo</option>
                            <option value="Directivo-docente">Directivo y Docente</option>
