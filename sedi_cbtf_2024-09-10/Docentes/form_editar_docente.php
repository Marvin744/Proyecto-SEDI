<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $sql = "UPDATE docentes SET 
                titulo_estudios = UPPER(:titulo_docente),
                nombre_docente = UPPER(:nombre_docente),
        ...
        $url_redireccion = 'form_docente_f19.php';
        echo "<script>
...
<body>
    <div class="unique-form-container">
        <h1 style="font-weight: bold;">MODIFICACIÓN DE DATOS DEL PERSONAL DEL PLANTEL</h1>
        <p style="font-size: 2rem;">Ingrese o modifique los datos del personal como se indican a continuación y luego dé clic en Actualizar información.</p><br>
        ...
        <form action="" method="POST">
            <fieldset>
                <div class="unique-form-group">
                    <label for="titulo_docente">Título docente: </label>
                    <input type="text" id="titulo_docente" name="titulo_docente" value="<?php echo $docente['titulo_estudios']; ?>" required>
                </div>
                ...
                <!-- Botón de envío -->
                <div>
                    <button type="submit" class="unique-submit-button">Actualizar Información</button>
                </div>
            </fieldset>
