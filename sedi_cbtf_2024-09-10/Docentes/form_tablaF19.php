...
<body>
    <h1 style="font-size: 2.4rem; font-weight: bold; text-align: center;">FORMATO 19 DE LOS DOCENTES</h1>
    <p style="font-size: 2rem;">A continuación se presentan las tablas del Formato 19 del docente, en la cual puede ingresar las horas en los recuadros en blanco. En el caso de las actividades 
    ...
    <p>NOTA: Corrobore los datos de las tablas y del último formulario (datos extra del formato como horas de contrato del docente) antes de generar el PDF.</p>
