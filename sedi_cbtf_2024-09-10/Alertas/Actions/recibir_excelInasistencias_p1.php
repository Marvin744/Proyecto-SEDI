<?php
    ...
    try {
        ...
        foreach ($lines as $line) {
            ...
            // Extracción de asistencias e inasistencias de las columnas correspondientes
            ...
            if (!$resultAsistencia) {
                ...
                $current_asistencias_p1 = $resultAsistencia['asistencias_p1'];
                $current_inasistencias_p1 = $resultAsistencia['inasistencias_p1'];
