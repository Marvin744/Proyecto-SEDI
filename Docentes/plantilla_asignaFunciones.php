...
$subtotal_lunes1 = isset($_POST['subtotal_lunes1']) ? $_POST['subtotal_lunes1'] : 0;
$subtotal_martes1 = isset($_POST['subtotal_martes1']) ? $_POST['subtotal_martes1'] : 0;
$subtotal_miercoles1 = isset($_POST['subtotal_miercoles1']) ? $_POST['subtotal_miercoles1'] : 0;
$subtotal_jueves1 = isset($_POST['subtotal_jueves1']) ? $_POST['subtotal_jueves1'] : 0;
$subtotal_viernes1 = isset($_POST['subtotal_viernes1']) ? $_POST['subtotal_viernes1'] : 0;
$subtotal_sabado1 = isset($_POST['subtotal_sabado1']) ? $_POST['subtotal_sabado1'] : 0;
$subtotal_horas1 = isset($_POST['subtotal_horas1']) ? $_POST['subtotal_horas1'] : 0;
...
function getPlantilla($folio,
    ...
    foreach ($array as $row) {
        ...
        $contenido .= "<td style='text-align: center; padding: 1px 1px;'>{$row['grupo']}</td>";
