    ...
    <table class="f19_table">
        ...
        <tfoot>
            <tr class="f19_header-row">
                ...
                <td class="f19_td" id="subtotal1-horas"><strong><?php echo $totalHorasSemanales; ?></strong></td>
            </tr>
        </tfoot>
    </table>
    <br>
    ...
    alert('Las horas no coinciden. Por favor, revise los horarios.');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateSubtotals() {
                ...
                document.getElementById('subtotal1-horas').textContent = Math.floor(subtotalHoras);
            }
