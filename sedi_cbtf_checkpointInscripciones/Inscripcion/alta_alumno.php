...
$insertar = "INSERT INTO `alumnos` (`id_alumno`, `matricula`, `nombre_alumno`, `apellido_paterno`, `apellido_materno`, `semestre`, `grupo`, `status`, `CURP`, `genero`, `edad`, `fecha_naci`, `lugar_nacimiento`, `nacionalidad`, `ayuda_español`, `telefono`, `correo`, `secundaria_egreso`, `promedio_secundaria`, `sangre`, `beca_bancomer`, `nss_issste`, `discapacidad_mo_psi`, `detalles_discapacidad`, `documento_validacion_discapacidad`, `alergia`, `detalles_alergias`, `requiere_medicacion`, `medicacion_necesaria`, `lentes_graduados`, `aparatos_asistencia`, `detalles_aparatos_asistencia`, `calle_numero`, `colonia`, `codigo_postal`, `dispositivo_internet`, `numero_dispositivos`, `nombre_tutor`, `telefono_tutor`, `nombre_madre`, `telefono_madre`, `nombre_padre`, `telefono_padre`, `EP_acta_nacimiento`, `EP_CURP`, `EP_comprobante_domicilio`, `EP_nss_issste`, `EP_certificado_secundaria`, `EP_ficha_psicopedagogica`, `EP_ficha_buena_conducta`, `EP_fotografias`, `EP_autenticacion_secundaria`, `observaciones`) 
            VALUES (UPPER(NULL, NULL, :nombre_alumno, :apellido_paterno, :apellido_materno, :semestre, NULL, :status, :curp, :genero, :edad, :fecha_naci, :lugar_nacimiento, :nacionalidad, :ayuda_espanol, :telefono, :correo, :secundaria_egreso, :promedio_secundaria, :sangre, :beca_bancomer, :nss_issste, :discapacidad_mo_psi, :detalles_discapacidad, :documento_validacion_discapacidad, :alergia, :detalles_alergias, :requiere_medicacion, :medicacion_necesaria, :lentes_graduados, :aparatos_asistencia, :detalles_aparatos_asistencia, :calle_numero, :colonia, :codigo_postal, :dispositivo_internet, :numero_dispositivos, :nombre_tutor, :telefono_tutor, :nombre_madre, :telefono_madre, :nombre_padre, :telefono_padre, :EP_acta_nacimiento, :EP_CURP, :EP_comprobante_domicilio, :EP_nss_issste, :EP_certificado_secundaria, :EP_ficha_psicopedagogica, :EP_ficha_buena_conducta, :EP_fotografias, :EP_autenticacion_secundaria, :observaciones))";
...
$query->bindValue(':nss_issste', $nss_issste, PDO::PARAM_INT); // Suponiendo que nss_issste es un entero
...
if ($resultado) {
    ...
    echo "<script>alert('Insercion exitosa');
    window.location.href='incripcion_alumno.php'; die;
    </script>";
} else {
