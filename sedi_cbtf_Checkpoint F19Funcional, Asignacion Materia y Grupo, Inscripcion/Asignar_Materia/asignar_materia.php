    ...
    <div>
        ...
        <label for="filtro_semestre">Seleccionar Semestre:</label>
            ...
            <select name="filtro_especialidad" id="filtro_especialidad">
                <?php 
                    $sqlEspecialidad = "SELECT DISTINCT e.id_especialidad, e.nombre_especialidad, t.tipo_programa
                                        FROM especialidad e
                    ...
                    foreach ($queryTableEspecialidad as $especialidad): ?>
                        <option value="<?= $especialidad['id_especialidad'] ?>"><?= $especialidad['nombre_especialidad'],", Programa: ",$especialidad['tipo_programa'] ?></option>
                <?php endforeach; ?>
            </select>
            ...
            <tbody>
                <?php
                    ...
                    $sqlAsignaturas = "SELECT a.id_asignatura,
                                    ...
                                    JOIN 
                                        tipo_programa t ON a.id_tipo_programa = t.id_tipo_programa
